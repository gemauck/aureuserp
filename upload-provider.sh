#!/bin/bash
# Upload AdminPanelProvider to Digital Ocean via SSH
# This file content needs to be copied to the server

echo "Creating AdminPanelProvider.php..."

mkdir -p /workspace/app/Providers/Filament

cat > /workspace/app/Providers/Filament/AdminPanelProvider.php << 'PHPEOF'
<?php
